...
test("defines the exact v0.1 release identities and four target assets", () => {
  ...
  expect(TARGETS).toEqual({
    "darwin-arm64": {
      ...
      asset: "tmux-pane-dash-v0.1.0-aarch64-apple-darwin.tar.gz",
    },
    "darwin-x64": {
      rustTarget: "x86_64-apple-darwin",
      asset: "tmux-pane-dash-v0.1.0-x86_64-apple-darwin.tar.gz",
    },
    "linux-arm64": {
      rustTarget: "aarch64-unknown-linux-musl",
      asset: "tmux-pane-dash-v0.1.0-aarch64-unknown-linux-musl.tar.gz",
    },
    "linux-x64": {
      rustTarget: "x86_64-unknown-linux-musl",
      asset: "tmux-pane-dash-v0.1.0-x86_64-unknown-linux-musl.tar.gz",
    },
  })
})
