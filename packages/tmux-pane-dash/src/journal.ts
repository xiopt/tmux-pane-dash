...
export type JournalMutation = { operation: "version" | "config" | "current" | "ownership" | "tombstone"; logicalPath: string; resolvedPath: string; pre: FileState; post: FileState; preimage: string | null; applied: boolean; backupPath?: string }
