...
function planOpenCodeEdit(input) {
  const desired = input.packageEntry ?? "@xiopt/pane-dash-opencode@0.1.8", text = decoder.decode(input.bytes), plugin = rootPlugin(text);
  if (plugin) {
...
var release_manifest_default = {
  assets: { "darwin-arm64": { asset: "tmux-pane-dash-v0.1.8-aarch64-apple-darwin.tar.gz", sha256: "1e39f5ef7488a52dcfd0669f5947db5539ae687207a171e22198afb882ed4aa1", size: 1523812, target: "aarch64-apple-darwin", url: "https://github.com/xiopt/tmux-pane-dash/releases/download/v0.1.8/tmux-pane-dash-v0.1.8-aarch64-apple-darwin.tar.gz" }, "darwin-x64": { asset: "tmux-pane-dash-v0.1.8-x86_64-apple-darwin.tar.gz", sha256: "862735c3679e32e9f74820360f690b8e62954372b79af165da69d4c587f3fc50", size: 8719, target: "x86_64-apple-darwin", url: "https://github.com/xiopt/tmux-pane-dash/releases/download/v0.1.8/tmux-pane-dash-v0.1.8-x86_64-apple-darwin.tar.gz" }, "linux-arm64": { asset: "tmux-pane-dash-v0.1.8-aarch64-unknown-linux-musl.tar.gz", sha256: "d6c6ea32265621cd1d66ddf7dca1c36d2da7a48a8f9c1383734e195e9162c804", size: 8715, target: "aarch64-unknown-linux-musl", url: "https://github.com/xiopt/tmux-pane-dash/releases/download/v0.1.8/tmux-pane-dash-v0.1.8-aarch64-unknown-linux-musl.tar.gz" }, "linux-x64": { asset: "tmux-pane-dash-v0.1.8-x86_64-unknown-linux-musl.tar.gz", sha256: "95a8068cdc75b27d5679159024e50dba49dd44b390e1c2f3e39eeaa95abe99f2", size: 8714, target: "x86_64-unknown-linux-musl", url: "https://github.com/xiopt/tmux-pane-dash/releases/download/v0.1.8/tmux-pane-dash-v0.1.8-x86_64-unknown-linux-musl.tar.gz" } },
