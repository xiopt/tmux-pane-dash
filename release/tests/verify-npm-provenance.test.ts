...
const handoff = {
  ...
  npm: {
    "@xiopt/pane-dash-opencode": { filename: "xiopt-pane-dash-opencode-0.1.7.tgz", integrity: packageIntegrity },
    "@xiopt/tmux-pane-dash": { filename: "xiopt-tmux-pane-dash-0.1.7.tgz", integrity: packageIntegrity },
  },
  ...
  releaseAssets: Object.fromEntries(["tmux-pane-dash-v0.1.7-aarch64-apple-darwin.tar.gz", "tmux-pane-dash-v0.1.7-x86_64-apple-darwin.tar.gz", "tmux-pane-dash-v0.1.7-aarch64-unknown-linux-musl.tar.gz", "tmux-pane-dash-v0.1.7-x86_64-unknown-linux-musl.tar.gz", "release-manifest.json", "SHA256SUMS"].map((name) => [name, "b".repeat(64)])),
} as const
...
test("bundled provenance CLI pins the current version before handoff and fetch I/O", async () => {
  ...
  try {
    ...
    const common = ["--package", "@xiopt/tmux-pane-dash", "--handoff", handoffPath, "--repository", "xiopt/tmux-pane-dash", "--workflow", ".github/workflows/release.yml", "--ref", "refs/tags/v0.1.7"] as const
...
const approval = { schemaVersion: 1, runId: 42, expectedSha: handoff.tagCommit, environment: { id: 99, name: "npm-production" }, approver: "reviewer", currentUserCanApprove: true, requestSha256: "c".repeat(64), response: { httpStatus: 200, runId: 42, environmentId: 99, deploymentId: 123, environment: "npm-production", sha: handoff.tagCommit, ref: "refs/tags/v0.1.7", approved: true } } as const
const deployments = [{
  url: "https://api.github.com/repos/xiopt/tmux-pane-dash/deployments/123", id: 123, node_id: "MDExOkRlcGxveW1lbnQxMjM=", sha: handoff.tagCommit, ref: "v0.1.7", task: "deploy", payload: {}, original_environment: "npm-production", environment: "npm-production", description: null, creator: {}, created_at: "2026-07-27T00:00:00Z", updated_at: "2026-07-27T00:00:00Z", statuses_url: "https://api.github.com/repos/xiopt/tmux-pane-dash/deployments/123/statuses", repository_url: "https://api.github.com/repos/xiopt/tmux-pane-dash", transient_environment: false, production_environment: true, performed_via_github_app: null,
}]
